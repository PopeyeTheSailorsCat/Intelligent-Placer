...
# План работы
* Шаг 1: Извлечь из изображения структуру фигуру, ее местоположение и картинки предметов: 
...
* Шаг 2: Классифицируем предметы с изображения, используя вырезанные фигуры:
  ...
  * Скомпилируем нашу модль и загрузим из репозитория сохраненные веса.
...
* Шаг 3: Располагаем предметы на фигуре.
  ...
  * Для каждой структуры каждого предмета из классифицированных, начинаем процедуру размещение на фигуре:
